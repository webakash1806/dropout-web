...
const Header = () => {
    ...
    return (
        <div className='fixed top-0 left-0 z-[100]'>
            ...
            ${barActive ? "top-[2.95rem] left-[-80rem] duration-[0.5s]" : "top-[6.5rem] left-0 duration-[0.5s]"}
                    ...
                    <div className="flex flex-col gap-3 xl:flex-row xl:gap-0 ">
                        ...
                        <div className="dropdown dropdown-hover">
                            ...
                            <ul tabIndex={0} className="dropdown-content z-[1] menu p-1 shadow bg-base-100 w-full xl:w-[17rem]">
                                <li>
                                    <Link to={'/'} className={`${navStyle} xl:w-[15rem] xl:p-2 xl:border-b rounded-none`}>Our Mission</Link>
                                    <Link to={'/'} className={`${navStyle} xl:w-[15rem] xl:p-2 xl:border-b rounded-none`}>Our Vision</Link>
                                    <Link to={'/'} className={`${navStyle} xl:w-[15rem] xl:p-2 xl:border-b rounded-none`}>Our Team</Link>
                                    <Link to={'/'} className={`${navStyle} xl:w-[15rem] xl:p-2 xl:border-b rounded-none`}>Our Approach</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="dropdown dropdown-hover">
